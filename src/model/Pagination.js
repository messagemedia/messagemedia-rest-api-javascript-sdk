...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessagemediaRestApi.Pagination = factory(root.MessagemediaRestApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('page_size')) {
        obj['page_size'] = ApiClient.convertToType(data['page_size'], 'Integer');
      }
      if (data.hasOwnProperty('total_count')) {
        obj['total_count'] = ApiClient.convertToType(data['total_count'], 'Integer');
      }
      if (data.hasOwnProperty('page_count')) {
        obj['page_count'] = ApiClient.convertToType(data['page_count'], 'Integer');
      }
