...
(function(root, factory) {
  ...
  /**
   * The AsyncDeliveryReportDetailRequest model module.
   * @module model/AsyncDeliveryReportDetailRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AsyncDeliveryReportDetailRequest</code>.
   * @alias module:model/AsyncDeliveryReportDetailRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>AsyncDeliveryReportDetailRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AsyncDeliveryReportDetailRequest} obj Optional instance to populate.
   * @return {module:model/AsyncDeliveryReportDetailRequest} The populated <code>AsyncDeliveryReportDetailRequest</code> instance.
   */
   ...
   * @member {module:model/AsyncDeliveryReportDetailRequest.SortByEnum} sort_by
   */
