...
(function(root, factory) {
  ...
  /**
   * The AsyncReceivedMessagesSummaryRequest model module.
   * @module model/AsyncReceivedMessagesSummaryRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AsyncReceivedMessagesSummaryRequest</code>.
   * @alias module:model/AsyncReceivedMessagesSummaryRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>AsyncReceivedMessagesSummaryRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AsyncReceivedMessagesSummaryRequest} obj Optional instance to populate.
   * @return {module:model/AsyncReceivedMessagesSummaryRequest} The populated <code>AsyncReceivedMessagesSummaryRequest</code> instance.
   */
   ...
   * @member {Array.<module:model/AsyncReceivedMessagesSummaryRequest.GroupByEnum>} group_by
   */
