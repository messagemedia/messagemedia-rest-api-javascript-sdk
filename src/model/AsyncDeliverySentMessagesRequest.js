...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessagemediaRestApi.AsyncDeliverySentMessagesRequest = factory(root.MessagemediaRestApi.ApiClient, root.MessagemediaRestApi.AccountsBody, root.MessagemediaRestApi.DeliveryOptionsBody, root.MessagemediaRestApi.DeliveryReportBody, root.MessagemediaRestApi.DestinationAddressBody, root.MessagemediaRestApi.DestinationAddressCountryBody, root.MessagemediaRestApi.EndDateBody, root.MessagemediaRestApi.MessageFormatBody, root.MessagemediaRestApi.MetadataKeyBody, root.MessagemediaRestApi.MetadataValueBody, root.MessagemediaRestApi.SourceAddressBody, root.MessagemediaRestApi.SourceAddressCountryBody, root.MessagemediaRestApi.StartDateBody, root.MessagemediaRestApi.StatusCodeBody, root.MessagemediaRestApi.SummaryByBody, root.MessagemediaRestApi.SummaryFieldBody, root.MessagemediaRestApi.TimezoneBody);
  }
}(this, function(ApiClient, AccountsBody, DeliveryOptionsBody, DeliveryReportBody, DestinationAddressBody, DestinationAddressCountryBody, EndDateBody, MessageFormatBody, MetadataKeyBody, MetadataValueBody, SourceAddressBody, SourceAddressCountryBody, StartDateBody, StatusCodeBody, SummaryByBody, SummaryFieldBody, TimezoneBody) {
  'use strict';
