...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessagemediaRestApi.Messages = factory(root.MessagemediaRestApi.ApiClient, root.MessagemediaRestApi.NewMessage);
  }
   ...
   * @class
   * @param messages {Array.<module:model/NewMessage>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('messages')) {
        obj['messages'] = ApiClient.convertToType(data['messages'], [NewMessage]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/NewMessage>} messages
   */
