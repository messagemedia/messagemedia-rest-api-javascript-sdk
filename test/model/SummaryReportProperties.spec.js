...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagemediaRestApi.SummaryReportProperties();
  });
  ...
  describe('SummaryReportProperties', function() {
    it('should create an instance of SummaryReportProperties', function() {
      // uncomment below and update the code to test SummaryReportProperties
      //var instane = new MessagemediaRestApi.SummaryReportProperties();
      //expect(instance).to.be.a(MessagemediaRestApi.SummaryReportProperties);
    });
