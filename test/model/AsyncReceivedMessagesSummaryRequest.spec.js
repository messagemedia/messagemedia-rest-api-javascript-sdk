...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagemediaRestApi.AsyncReceivedMessagesSummaryRequest();
  });
  ...
  describe('AsyncReceivedMessagesSummaryRequest', function() {
    it('should create an instance of AsyncReceivedMessagesSummaryRequest', function() {
      // uncomment below and update the code to test AsyncReceivedMessagesSummaryRequest
      //var instane = new MessagemediaRestApi.AsyncReceivedMessagesSummaryRequest();
      //expect(instance).to.be.a(MessagemediaRestApi.AsyncReceivedMessagesSummaryRequest);
    });
