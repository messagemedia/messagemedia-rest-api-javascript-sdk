...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagemediaRestApi.AsyncReceivedMessagesDetailRequest();
  });
  ...
  describe('AsyncReceivedMessagesDetailRequest', function() {
    it('should create an instance of AsyncReceivedMessagesDetailRequest', function() {
      // uncomment below and update the code to test AsyncReceivedMessagesDetailRequest
      //var instane = new MessagemediaRestApi.AsyncReceivedMessagesDetailRequest();
      //expect(instance).to.be.a(MessagemediaRestApi.AsyncReceivedMessagesDetailRequest);
    });
