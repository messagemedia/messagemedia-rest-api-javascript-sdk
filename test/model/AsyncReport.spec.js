...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagemediaRestApi.AsyncReport();
  });
  ...
  describe('AsyncReport', function() {
    it('should create an instance of AsyncReport', function() {
      // uncomment below and update the code to test AsyncReport
      //var instane = new MessagemediaRestApi.AsyncReport();
      //expect(instance).to.be.a(MessagemediaRestApi.AsyncReport);
    });
    ...
    it('should have the property lastModifiedDatetime (base name: "last_modified_datetime")', function() {
