...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagemediaRestApi.Reply();
  });
  ...
  describe('Reply', function() {
    it('should create an instance of Reply', function() {
      ...
      //var instane = new MessagemediaRestApi.Reply();
      //expect(instance).to.be.a(MessagemediaRestApi.Reply);
    });
    ...
    it('should have the property replyId (base name: "reply_id")', function() {
