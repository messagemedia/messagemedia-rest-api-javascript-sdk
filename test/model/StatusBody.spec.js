...
(function(root, factory) {
  ...
  describe('StatusBody', function() {
    it('should create an instance of StatusBody', function() {
      // uncomment below and update the code to test StatusBody
      //var instane = new MessagemediaRestApi.StatusBody();
      //expect(instance).to.be.a(MessagemediaRestApi.StatusBody);
    });
