...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagemediaRestApi.AsyncDeliverySentMessagesRequest();
  });
  ...
  describe('AsyncDeliverySentMessagesRequest', function() {
    it('should create an instance of AsyncDeliverySentMessagesRequest', function() {
      // uncomment below and update the code to test AsyncDeliverySentMessagesRequest
      //var instane = new MessagemediaRestApi.AsyncDeliverySentMessagesRequest();
      //expect(instance).to.be.a(MessagemediaRestApi.AsyncDeliverySentMessagesRequest);
    });
