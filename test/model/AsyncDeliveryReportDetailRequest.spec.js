...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagemediaRestApi.AsyncDeliveryReportDetailRequest();
  });
  ...
  describe('AsyncDeliveryReportDetailRequest', function() {
    it('should create an instance of AsyncDeliveryReportDetailRequest', function() {
      // uncomment below and update the code to test AsyncDeliveryReportDetailRequest
      //var instane = new MessagemediaRestApi.AsyncDeliveryReportDetailRequest();
      //expect(instance).to.be.a(MessagemediaRestApi.AsyncDeliveryReportDetailRequest);
    });
